namespace SMS
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "Ολοκλήρωση Ελέγχου";
            ...
            this.button2.Text = "Ολοκλήρωση Επισκευής";
            ...
            this.button3.Text = "Αντικατάσταση";
            ...
            this.button4.Text = "Επικοινωνήστε μαζί μας";
            ...
            this.button5.Text = "Πίστωση προβληματικού";
            ...
            this.button7.Text = "Αντιπροσωπεία";
